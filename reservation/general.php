...
if (isset($_POST["reserver"])){
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$sql = "INSERT INTO reservation (Nom, destination, agence, heure_depart, bagage, classe, siege,adulte,enfant)
				VALUES ('$nom', '$destination', '$agence', '$heure_depart', '$bagage', '$classe', '$siege','$adulte','$enfant')";
				...
				<div class="row">
					<div class="col-md-7 col-md-push-5">
						<div class="booking-cta">
							<h1>GENERAL VOYAGE: LE PLAISIR DE VOYAGER</h1>
							<p>"Bienvenue chez GENERAL VOYAGE, votre partenaire de confiance pour des expériences de voyage inoubliables !"</p>
							...
							<form action="" method = "post">
								...
								<div class="row">
									...
									<div class="form-group">
											...
											<input class="form-control" type="time" required name="heure_depart">
										</div>
									</div>
									<div class="col-sm-6">
									<div class="form-group">
