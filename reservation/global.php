				...
				<div class="row">
					<div class="col-md-7 col-md-push-5">
						<div class="booking-cta">
							<h1>GLOBAL VOYAGE</h1>
							<p>"Bienvenue chez GLOBAL VOYAGE, votre partenaire de confiance pour des expériences de voyage inoubliables !"</p>
							<p>"Nous avons des familles heureuses, des couples émerveillés et des amis en train de partager des moments uniques dans des destinations de rêve. 
                                Ils se détendent sur des plages de sable fin, explorent des villes animées et s'émerveillent devant des merveilles naturelles."
							</p>
						</div>
					</div>
