				...
				<div class="row">
					<div class="col-md-7 col-md-push-5">
						<div class="booking-cta">
							<h1>MEN TRAVEL</h1>
							<p> "Avec notre agence de voyage, vous pouvez choisir parmi une vaste sélection de destinations de rêve. 
								Que vous souhaitiez vous détendre sur une plage paradisiaque, explorer des sites historiques ou partir
								 à l'aventure dans des contrées lointaines, nous avons le voyage parfait pour vous."
							</p>
							<p>On montre des réductions attrayantes, des forfaits promotionnels et des offres spéciales qui clignotent à l'écran.
							Des images de chambres d'hôtel luxueuses, de repas savoureux et d'activités passionnantes mettent en valeur 
							.
							</p>
						</div>
					</div>
